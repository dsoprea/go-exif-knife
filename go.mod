...
require (
	...
	github.com/dsoprea/go-jpeg-image-structure v0.0.0-20200322051316-735e765a68ee
	github.com/dsoprea/go-logging v0.0.0-20190624164917-c4f10aab7696
	github.com/dsoprea/go-png-image-structure v0.0.0-20200322042450-b1b64b6b17f4
